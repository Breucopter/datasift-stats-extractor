...
module.exports = {
	...
	putInfluencerModel : function(data) {
		...
		if (data.twitter !== undefined && data.twitter.retweeted !== undefined && data.twitter.retweeted.user !== undefined && data.twitter.retweeted.user.screen_name !== undefined && data.twitter.retweeted.user.followers_count !== undefined ){
			...
			// Save the description if we have it
      if(data.twitter.retweeted.user.description !== undefined){
        influencers.samplemodel[data.twitter.retweeted.user.screen_name].description = influencers.samplemodel[data.twitter.retweeted.user.screen_name].description || data.twitter.retweeted.user.description;
      } else {
        influencers.samplemodel[data.twitter.retweeted.user.screen_name].description = influencers.samplemodel[data.twitter.retweeted.user.screen_name].description || 'Undefined';
      }
