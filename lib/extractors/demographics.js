...
module.exports = {
  ...
  putDemographics : function(data) { 	
    ...
    if(data.interaction !== undefined && data.demographic !== undefined){
    	...
    	// Gender by tag
    	/*
    	if(data.interaction !== undefined && data.interaction.tags !== undefined && data.demographic.gender !== undefined){
		  	...
		  	for(var tag in data.interaction.tags){
	    		...
	    		if(eachgender === 'mostly_male'){
		  		...
		  		tags.gender[eachTag][eachgender] = tags.gender[eachTag][eachgender] || 0;
		  		tags.gender[eachTag][eachgender] ++;
	 		}		  
    	}
    	 */  	
