...
module.exports = {
	...
	putInfluencer : function(data) {
		...
		if (data.twitter !== undefined && data.twitter.retweet !== undefined && data.twitter.retweet.user !== undefined && data.twitter.retweet.user.screen_name !== undefined 
			...
			//influencers[data.twitter.retweet.user.id][data.twitter.retweeted.user.id] = influencers[data.twitter.retweet.user.id][data.twitter.retweeted.user.id] || 0;
			//influencers[data.twitter.retweet.user.id][data.twitter.retweeted.user.id] ++; 
