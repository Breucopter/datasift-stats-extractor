...
module.exports = {
  ...
  dumpFiles: function () {
	...
	try {
		...
		console.log('(10/20) Rendering sentiment..');
		salience.renderSentiment();	
		console.log('(11/20) Rendering entity locations..');
		salience.renderLocations();
		console.log('(12/20) Rendering entity quotes..');
		salience.renderQuotes();
		console.log('(13/20) Rendering topics..');
		salience.renderTopics();
		
		console.log('(14/20) Rendering languages..');
		language.renderLanguage();
		
		console.log('(15/20) Rendering domains..');
		links.renderUrlDomains();
		
		console.log('(16/20) Rendering retweets..');
		twitter.renderRetweetRetweeted();
		console.log('(17/20) Rendering twitter id\'s..');	
		twitter.renderTwitterIds();
		console.log('(18/20) Rendering twitter id\s by tag..');
		twitter.renderTwitterIdTags();
		console.log('(19/20) Rendering sample influencer model..');
		twitter.renderInfluencerModel();
		
		console.log('(20/20) Rendering demographics..');
