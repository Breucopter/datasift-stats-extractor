...
module.exports = {
	...
	renderQuotes : function() {
	  	if(utils.isEmpty(salience.quotes) === false){
		  	var dump_salience_quotes = '';
		  	dump_salience_quotes += 'Quote,Volume' + "\n";
		  	for(var quote in salience.quotes){
		  		dump_salience_quotes += '"' + quote + '",' + salience.quotes[quote].count + "\n";
		 	}
			filehandler.save('salience_entity_quotes.csv', dump_salience_quotes);
		}	
