...
var augmentations	= require('../lib/renderers/augmentations');
...
module.exports = {
  ...
  dumpFiles: function () {
	...
	try {
		...
		console.log('(23/24) Rendering Facebook Page volumes..');
		facebookpage.renderPageVolumes();
		
		console.log('(24/24) Rendering Augmentation Summary stats..');
		augmentations.renderAugmentationStats();		
